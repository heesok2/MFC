...
BEGIN_MESSAGE_MAP(CMYEXDoc, CDocument)
	...
	ON_COMMAND_RANGE(ID_MYEX_DB_EXAMPLE, ID_MYEX_DB_EXAMPLE, OnRibbonCategory)
	...
	ON_UPDATE_COMMAND_UI_RANGE(ID_MYEX_DB_EXAMPLE, ID_MYEX_DB_EXAMPLE, OnRibbonCategoryUI)
END_MESSAGE_MAP()
