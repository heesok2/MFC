...
void CFrameBuffer::GLCreateFrameBuffer()
{
...
BOOL CFrameBuffer::GLCreateColorTexture2D(UINT uiAttachment, int x, int y)
{
...
BOOL CFrameBuffer::GLCreateDepthStencilRender(int x, int y)
{
